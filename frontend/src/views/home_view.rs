    ...
    html! {
        <table class="border-separate border-spacing-1 w-full">
            <tr>
                ...
                <td class="w-1/2 p-0">
                    <button onclick={navigator(Route::SetupJoin)} class="h-full w-full bg-brand-secondary text-brand-text rounded-tr-2xl flex flex-col hover:opacity-90 transition-opacity">
                        <div class="text-left p-3 font-bold text-2xl flex justify-between items-center">
                            <table class="w-full">
                                <tr>
                                    <td class="flex-1">
